    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdminRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(enteredName.isEmpty() || enteredEmail.isEmpty() || enteredCPF_CNPJ.isEmpty() || enteredPass1.isEmpty() || enteredPass2.isEmpty()) {
                    ...
                    pref = getSharedPreferences(enteredCPF_CNPJ, MODE_PRIVATE);
